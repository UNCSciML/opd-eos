#!/usr/bin/env bash
#SBATCH --job-name=opd_k2_7b_base400
...
# TTRL, vanilla OPD (EOS_MODE=baseline: official rollout stop set {1,250019}, EOS tokens supervised separately).
#
...
export RAY_MIN_WORKER_PORT=${RAY_MIN_WORKER_PORT:-35000}
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-opd_ttrl_k2_7b_pretrainfinal_to_main_baseline_${RUN_SUFFIX}}
