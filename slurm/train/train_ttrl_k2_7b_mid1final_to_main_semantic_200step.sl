#!/usr/bin/env bash
#SBATCH --job-name=opd_k2_7b_mid1final_sem200
...
#SBATCH --gres=gpu:4
# K2-Horizon-7B student = `mid_1_final` <- teacher = main, semantic-EOS-class OPD (EOS_MODE=semantic_class).
# Paired with train_ttrl_k2_7b_mid1final_to_main_baseline_200step.sl: the same stage-control student
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-opd_ttrl_k2_7b_mid1final_to_main_semantic_class_${RUN_SUFFIX}}
