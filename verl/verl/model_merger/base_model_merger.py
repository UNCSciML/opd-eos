    ...
    def get_transformers_auto_model_class(self):
        ...
        if has_remote_code:
            ...
            if "ForTokenClassification" in self.model_config.architectures[0]:
                ...
                # transformers>=4.5x maps modern VLMs (e.g. Gemma3) to ImageTextToText; the
                # legacy Vision2Seq shim neither maps them nor accepts dtype kwargs.
    ...
    def save_hf_model_and_tokenizer(self, state_dict: dict[str, torch.Tensor]):
        ...
        with init_empty_weights():
            try:
                ...
                # legacy auto classes (e.g. AutoModelForVision2Seq) only accept the config
                model = auto_model_class.from_config(self.model_config).to(torch.bfloat16)
